                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input value="{{ $job->location }}" type="text" placeholder="location" id="job_location" name="location" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input {{ $job->keywords }} type="text" placeholder="keywords" id="keywords" name="keywords" class="form-control">
                            </div>
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input {{ $job->company_name }} type="text" placeholder="Company Name" id="company_name" name="company_name" class="form-control">
                                    <p></p>
                                </div>
                                <div class="mb-4 col-md-6">
                                    <label for="" class="mb-2">Location<span class="req">*</span></label>
                                    <input {{ $job->company_location}} type="text" placeholder="Location" id="company_location" name="company_location" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" {{ $job->company_website }} placeholder="Website" id="website" name="website" class="form-control">
                            </div>
                        </div> 
